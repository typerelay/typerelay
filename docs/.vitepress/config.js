...
const sections = {"guide": ["Guide", [["index", "Introduction"], ["libraries", "Libraries and sharing"], ["snippets", "Text and code snippets"], ["imports", "Import and export"], ["trash", "Trash"], ["settings", "Settings"]]], "desktop": ["Desktop", [["index", "Overview"], ["installation", "Installation"], ["panel", "Search panel"], ["sync", "Sync and offline use"], ["troubleshooting", "Troubleshooting"]]], "cli": ["CLI/TUI", [["index", "Command line"], ["tui", "Terminal editor"]]], "cloud": ["Cloud", [["index", "Hosted deployment status"]]], "selfhosted": ["Self-Hosted", [["index", "Development and deployment"], ["configuration", "Configuration"]]], "mcp": ["MCP", [["index", "Overview"], ["setup", "Setup"], ["tools", "Tools"], ["agents", "Agent configuration"]]], "api": ["API", [["index", "Overview"], ["authentication", "Authentication"], ["workflows", "Workflows"], ["errors", "Errors and limits"]]]};
export default defineConfig({ title: 'TypeRelay Docs', description: 'TypeRelay snippets, desktop clients, API and MCP', base, cleanUrls: true,
 srcExclude: ['README.md', 'INSTALLATION.md', 'CONFIGURATION.md', 'VERIFICATION.md', 'AGENTS.md', 'development/**', 'web/**', 'desktop/delivery.md', 'desktop/code-snippets.md'],
