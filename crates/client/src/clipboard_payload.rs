...
pub struct ClipboardPayload { pub characters:usize,pub plain:String,pub html:Option<String>,pub rtf:Option<String> }
#[derive(Clone,Debug,PartialEq,Eq)]
pub enum ClipboardStep { Payload(ClipboardPayload), Enter }
impl ClipboardPayload { pub fn text(value:String)->Self{Self{characters:value.chars().count(),plain:value,html:None,rtf:None}} }
