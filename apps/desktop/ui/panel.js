class Panel {
	constructor() {
		...
		window.__TAURI__.event.listen('sync-notice',event=>{const button=document.querySelector('#sync');button.disabled=event.payload.running;button.textContent=event.payload.running?'Syncing…':'Sync now';});
