...
export class BrowserSource {
	static async script() {
		const files = ['template-runtime.js', 'rich-text-runtime.js', 'template-editor.js', 'abbreviation.js', 'product-updates.js', 'trial-countdown.js', 'password-field.js', 'app.js'];
