...
process.env.MONGODB_URI = 'mongodb://mongo:27017/typerelay_template_browser?replicaSet=typerelay';
process.env.SESSION_SECRET_FILE = '/tmp/template-browser-session';
process.env.MCP_SECRET_FILE = '/tmp/template-browser-mcp';
